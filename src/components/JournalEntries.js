...
const Entries = () => {
    ...
    useEffect(() =>{
        fetch('http://170.64.177.128:5000/entries')//updated code to tell BE to fetch data on render.
        .then(res =>{
    ...
    const handleDelete = (id) =>{
        ...
        fetch(`http://170.64.177.128:5000/entries/${id}`, {//``and $ actually solved my DataBase problem
            method: 'DELETE',
        })
        .then(response => {
